...
//const char *password = "ojtech230502";
const char *ssid = "MTNHyNetflex";
const char *password = "90909090";
//************************************************************************
String getData, Link;
 
//String URL = "http://192.168.43.31/apsyste/bio_attendance.php";

 String URL = "https://bioattendancepayroll.000webhostapp.com/bio_attendance.php";
...
void SendFingerprintID( int finger ){
  ...
  if(WiFi.isConnected()){
    ...
    //GET Data
    getData = "?FingerID=" + String(finger) +"&status_state="+String(buttonState); // Add the Fingerprint ID to the Post array in order to send it
    //GET methode
    Link = URL + getData;
